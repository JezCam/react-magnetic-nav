...
import AnimatedThemeIcon from '@/components/animation/animated-theme-icon'
import { NewThemeToggle } from '@/components/animation/new-theme-toggle'
            ...
            <div className="flex flex-col gap-6 items-center justify-center">
                ...
                <div className="relative flex flex-col gap-2 w-full">
                    <div className="absolute right-7 top-10">
                        <CopyButton text={implementationCode} />
                    </div>
                    <h2 className="font-medium text-sm ml-3">
                        /components/magnetic-nav-implementation.tsx
                    </h2>
